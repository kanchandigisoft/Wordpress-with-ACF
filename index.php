    ...
    <section class="cream">
        <div class="wrapper">
            <div class="row middle-xs center-xs pad-xs-30 pad-top-bottom thirdheight">
                <div class="col-xs-12">
                    <h1 class="heavy">Grow your Shopify traffic & sales</h1>
            ...
            <div class="wrapper">
                ...
                <div class="row middle-xs between-xs pad-xs-15 pad-top-bottom">
                    ...
                    <div class="col-xs-12 col-sm-4 pad-xs-25 pad-left-right end-xs">
                        <button class="fullwidthmobile red"><a href="/contact/">Claim my Free 30 Minutes</a></button>
                    </div>
                </div>
                <div class="sp-20 hide-md"></div>
            </div>
    ...
    <?php while( have_posts() ): the_post(); ?>
        ...
        <?php if( $count==3 || $count==6 ): ?>
                    ...
                    <article class="row rounded border ad">
                        <div class="col-xs-12 col-sm-6 col-md-12 col-lg-6" style="background:url('<?php the_field('blog_ad_image','option'); ?>') no-repeat center center; background-size:cover;">
