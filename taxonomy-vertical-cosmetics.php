 ...
 <section class="cream">
        <div class="wrapper">
            <div class="row middle-xs center-xs pad-xs-30 pad-top-bottom thirdheight">
                <div class="col-xs-12">
                    <h1 class="heavy">Shopify Store Examples - <?php the_taxonomies(array('template' => '% %l')); ?></h1>
            ...
            <?php while( have_posts() ): the_post(); ?>
                ...
                <div class="col-xs-12 col-md-6">
                    <div class="row store white">
                        <div class="col-xs-12 pad-xs-0" style="background:url('<?php the_post_thumbnail_url(); ?>') no-repeat center center; background-size:cover;">
                        ...
                        <div class="col-xs-12 pad-xs-30 pad-sm-40 pad-left-right">
                            ...
                            <a href="<?php the_permalink(); ?>">
                                <h2><?php the_title(); ?></h2>
                                <h5 class="h5 underline"><?php the_taxonomies(array('template' => '% %l')); ?></h5>
                                <div class="sp-15"></div>
                            </a>
                        </div>
                    </div>
